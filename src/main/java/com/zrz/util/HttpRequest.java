...
public class HttpRequest {
	...
	//超时时间
//	private static int outTime = 1000*5;
...
//                System.out.println(key + "--->" + map.get(key));
     ...
     * @return 所代表远程资源的响应结果
     */
    public static String sendPost(String url, String param ,String codeType ,int outTime 
        ...
        try {
            ...
            in = new BufferedReader(
                    new InputStreamReader(conn.getInputStream(),codeType));//设置编码
            String line;
            while ((line = in.readLine()) != null) {
                result += line;
            }
