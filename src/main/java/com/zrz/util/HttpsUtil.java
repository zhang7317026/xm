...
public class HttpsUtil {
    ...
    private static HttpsURLConnection getHttpsURLConnection(String uri, String method ,String cookie) throws IOException {
        SSLContext ctx = null;
        try {
    ...
    public static String doGet(String url, String cookie) throws IOException {
        HttpsURLConnection httpsConn = getHttpsURLConnection(url, "GET" ,cookie);
        return new String(getBytesFromStream(httpsConn.getInputStream()));
    }
 
    public static String doPost(String url, String data ,String cookie) throws IOException {
        HttpsURLConnection httpsConn = getHttpsURLConnection(url, "POST" ,cookie);
    ...
    public static void main(String[] args) throws IOException {
		String rs = doGet("https://androidinvest.com/chinaindicespe/sh000300/" ,"");
